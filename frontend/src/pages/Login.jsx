...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black relative overflow-hidden">
      ...
      {/* Background blobs */}
      <div className="absolute top-[-10%] left-[-10%] w-96 h-96 bg-green-500/20 rounded-full blur-[100px] animate-pulse" />
      <div className="absolute bottom-[-10%] right-[-10%] w-96 h-96 bg-emerald-600/20 rounded-full blur-[100px] animate-pulse" />
      ...
      <GlassCard className="w-full max-w-md mx-4 relative z-10 p-8 border-green-500/20 shadow-green-500/5">
        ...
        >
          ...
          <div className="mt-6 text-center text-sm text-gray-400">
            ...
            <Link to="/register" className="text-green-500 hover:text-green-400 ml-2 font-medium">
              Sign up
            </Link>
          </div>
        </motion.div>
