...
import { Activity, Dumbbell, Scale, Flame, Apple, TrendingUp } from 'lucide-react';
    ...
    >
      <motion.div variants={item}>
        <h1 className="text-3xl md:text-4xl font-bold">
          Welcome back, <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-600">{user?.name || 'Champion'}</span> 💪
        </h1>
        <p className="text-gray-400 mt-2">Here's your activity overview for today.</p>
      </motion.div>
          ...
          <motion.div variants={item}>
            <GlassCard className="bg-gradient-to-br from-gray-800/50 to-emerald-900/20 border-emerald-500/20">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-emerald-400">Diet Tip</h3>
                  <p className="text-sm text-gray-300 mt-2">
                    Increase protein intake for better muscle recovery after today's heavy session.
                  </p>
                </div>
              </div>
            </GlassCard>
